...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-08-15 | performance-scaling | Loom timeout (degraded night) | NONE | NONE | yes | INCONCLUSIVE |  | dba5dba8 |  |
| 2026-08-15 | performance-scaling | a performance deep is unevaluable when the only evaluator measures correctness,  | NONE | NONE | yes | INCONCLUSIVE |  | 8a7c14cf0de7 |  |
| 2026-08-15 | performance-scaling | Given the official `perf` evaluator output for nostr-bbs-core as run tonight, wh | NONE | NONE | yes | INCONCLUSIVE |  | 542e14f476a3 |  |

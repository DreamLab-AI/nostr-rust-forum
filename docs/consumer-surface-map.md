...
**Generated:** 2026-05-17 (1.0.0-beta.2 / git control panel + JSS #464 + native pod tier)
**Pin:** `solid-pod-rs` `0.4.0-alpha.17` from crates.io (`default-features = false, features = ["core"]`; superseded git revs `4ac7670` alpha.14 / `8668792`)
